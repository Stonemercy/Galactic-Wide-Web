...
from data.lists import SpecialUnits, faction_colours, stratagem_id_dict
from disnake import APISlashCommand, Colour, Embed, File, Guild, OptionType
from utils.bot import GalacticWideWebBot
from utils.data import DarkEnergy, GalacticWarEffect, Planet, Planets, SiegeFleet, Steam
...
class PlanetCommandEmbed(Embed, EmbedReprMixin):
    ...
    def add_planet_info(
        ...
        for special_unit in SpecialUnits.get_from_effects_list(planet.active_effects):

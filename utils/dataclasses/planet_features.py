...
class PlanetFeatures:
    feature_codes_map = {
        ...
        ("EAGLE STORM", Emojis.SpaceStations.DSS.eagle_storm): {1212},
        ("ORBITAL BLOCKADE", Emojis.SpaceStations.DSS.orbital_blockade): {1213},
        ...
        ("COMMUNICATIONS ARRAY", Emojis.Factions.automaton): {1387},
    }
    ...
    def get_from_effects_list(cls, active_effects: set) -> set[tuple[str, str]]:
        ...
        for ae in active_effects:
            ...
            if features_list:
                planet_features.add(features_list[0])
